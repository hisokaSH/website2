          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            {user ? (
              ...
              <>
                ...
                <a href="https://discord.gg/vulcansolutions" target="_blank" rel="noreferrer" className="btn-discord">
          ...
          <div className="card overflow-hidden relative">
            ...
            <div className="relative p-10 sm:p-14 text-center">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a href="https://discord.gg/vulcansolutions" target="_blank" rel="noreferrer" className="btn-ghost">
                  Visit Discord
                </a>
              </div>
            </div>
